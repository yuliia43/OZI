...
class Program_menu():
    ...
    def authorization(self):
        ...
        if user_row is None:
            ...
            while incorrect_password_count != 3:
                ...
                password = input()
                password_valid = Program_menu.password_is_true(user_row, password)
    ...
    def change_password_menu(self):
        ...
        while incorrect_password_count != 3:
            ...
            old_password = input()
            password_valid = Program_menu.password_is_true(user_row, old_password)
            if not password_valid:
                print(Fore.LIGHTRED_EX, "Incorrect password")
                print(Style.RESET_ALL)
                incorrect_password_count += 1
    ...
    @staticmethod
    def password_is_true(user_row, password):
        if (user_row["Is blocked"] == 0).any():
            return (user_row["Password"] == password).any()
        else:
            return None
